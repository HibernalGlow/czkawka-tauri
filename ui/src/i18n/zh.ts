...
export const zh: Record<TranslationKeys, string> = {
  ...
  'Data analysis': '数据分析',
  'File format': '文件格式',
  'No data available': '暂无统计数据',
  'No similarity data available': '暂无相似度统计数据',
  ...
  'Configure card visibility and order': '配置各面板的卡片可见性和顺序',
  'Search cards': '搜索卡片...',
  ...
  'Format size chart': '格式大小图表',
  Logs: '日志',
  Undo: '撤销',
  Redo: '重做',
  'Group Selection': '按组选择',
  'Text Selection': '按文本选择',
  'Directory Selection': '按目录选择',
  Mode: '模式',
  ...
  Marked: '已标记',
  Unmarked: '未标记',
  'Group Has Some Marked': '组内有部分标记',
  'Group All Unmarked': '组内全部未标记',
  'Group Some Not All': '组内部分标记',
  'Group All Marked': '组内全部标记',
  Protected: '已保护',
  'Group Count': '组文件数',
  'Group File Count': '组文件数量',
  'Group Total Size': '组总大小',
  Min: '最小',
  Max: '最大',
  Done: '完成',
  NoPreset: '无预设',
  ...
  OldFiles: '旧文件',
  ShowSelectedOnly: '仅显示已选择',
  Items: '项目',
  Groups: '组',
  Refresh: '刷新',
  ClearFilters: '清除过滤',
  ActiveFilters: '个激活',
  ShowAllInFilteredGroups: '显示过滤组中的所有文件',
  MinResolution: '最小分辨率',
  MaxResolution: '最大分辨率',
  AspectRatio: '宽高比',
  Any: '任意',
