          ...
          (preset) => {
            ...
            if (preset === 'none') {
              ...
              if (presetConfig.fileSize) {
                expect(result.fileSize.enabled).toBe(presetConfig.fileSize.enabled);
              ...
              if (presetConfig.modifiedDate) {
                expect(result.modifiedDate.enabled).toBe(presetConfig.modifiedDate.enabled);
                expect(result.modifiedDate.preset).toBe(presetConfig.modifiedDate.preset);
              }
            }
          }
        ),
