  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-3xl max-h-[90vh] flex flex-col p-4 gap-4">
          ...
          <Tabs defaultValue="format" className="flex-1 flex flex-col min-h-0">
            ...
            <div className="flex-1 overflow-auto pr-2 custom-scrollbar min-h-0">
              <TabsContent value="format" className="mt-0 focus-visible:outline-none">
              ...
              <TabsContent value="similarity" className="mt-0 focus-visible:outline-none">
